...
getMyEle('#btnTinh').onclick = function() {
   ...
   getMyEle('#txtThongBao').innerHTML = thongBaoDiem
 }
...
getMyEle('#btnTienDien').onclick = function() {
   ...
   getMyEle('#txtThongBaoTienDien').innerHTML = 'Họ tên: ' + inputHoTen + ' Tiền điện: ' + tienDien
 }
...
getMyEle('#btnThue').onclick = function(){
   ...
   getMyEle('#txtThueThuNhap').innerHTML = thuNhapThue
}
...
getMyEle('#btnTienCap').onclick = function(){
   ...
   getMyEle('#txtTienCap').innerHTML = 'Mã khách hàng: ' + maKH + ' Tiền cáp: $' + tongTien
}
